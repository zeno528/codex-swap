...
- 🐛 fix: 统一输出格式，确保变量在提示信息中正确显示


## [0.2.76] - 2026-08-04

- 🐛 fix(test): 移除测试失败时的行号输出，简化错误处理
...
- ✨ feat(provider): 添加 provider 段显示名提取工具，优化多命中消歧逻辑


## [0.2.71] - 2026-08-02

- ✨ feat(config): 添加 config 与模板内容差异行数计算工具，优化多命中消歧逻辑


## [0.2.70] - 2026-08-02

- 🐛 fix(update): 修复安装目录被锁定时升级失败的问题
